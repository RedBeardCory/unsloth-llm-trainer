...
class BaseReader:
    ...
    def read(self, name, instructions, split_infos, in_memory=...): # -> dict[str, Table | DatasetInfo | NamedSplitAll | NamedSplit | None]:
    ...
    def read_files(self, files: list[dict], original_instructions: Union[None, ReadInstruction, Split] = ..., in_memory=...): # -> dict[str, Table | DatasetInfo | NamedSplitAll | NamedSplit | None]:
